                        ...
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Tabel Surat</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4" id="mahasiswa">
                  <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Daftar Laporan Peserta Magang</h6>
                  </div>
                  <div class="card-body">
                          ...
                          if (!empty($surat)) {
                           ...
                           ?>
                            <tr>
                              ...
                              <td>
                                <?php echo $isi->nama_file; ?>
                              </td>
                              <td>
                                <?php echo date('d-m-Y', strtotime($isi->tanggal_upload)); ?>
                              </td>
                              <td>
                                <?php echo $isi->waktu_upload; ?>
                              </td>
                              <td>
                                <a onclick="deleteConfirm('<?php echo site_url('Admin/hapus_surat/'.$isi->nama_file);?>')"
