                          ...
                          if (!empty($user)) {
                           ...
                           ?>
                            <tr>
                              ...
                              <td>
                                <?php echo $isi->password; ?>
                              </td>
                              <td>
                                <?php echo $isi->email; ?>
                              </td>
                              <td>
                                <a href="<?php base_url(); ?>edit_user/<?php echo $isi->no_regis; ?>" class="btn btn-small text-primary"><i class="far fa-edit"></i> Edit Data</a>
                                <a onclick="deleteConfirm('<?php echo site_url('Admin/hapus_user/'.$isi->no_regis);?>')"
