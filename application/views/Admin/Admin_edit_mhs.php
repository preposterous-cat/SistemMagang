             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Edit <?php echo $mhs->nim; ?></h4>
                ...
                <div class="row">
                  <div class="container-fluid">
                    <?php if ($this->session->flashdata('success_update')){ ?>
                        ...
                        <?php } ?>
                    <form method="POST" action="<?php site_url('Admin/edit_mhs/'.$mhs->nim); ?>">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <input class="form-control <?php echo form_error('start') ? 'is-invalid':'' ?>" id="date-input" type="date" name="start" value="<?php echo date('Y-m-d', strtotime($mhs->start)); ?>" required>
                        </div>
                      </div>
                      <div class="form-group row">
                        <label class="col-md-3 col-form-label" for="date-input">Masukkan Waktu Selesai Kegiatan</label>
                        <div class="col-md-9">
                          <input class="form-control <?php echo form_error('end') ? 'is-invalid':'' ?>" id="date-input" type="date" name="end" value="<?php echo date('Y-m-d', strtotime($mhs->end)); ?>" required>
                        </div>
                      </div>
                      <div class="form-group row">
