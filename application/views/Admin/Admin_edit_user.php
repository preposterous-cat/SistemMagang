...
<head>
    ...
    <!-- Favicon icon -->
    <title><?php echo $user->nisn; ?> - Kerja Praktik</title>
    <!-- Custom CSS -->
             ...
             <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h4 class="page-title">Edit <?php echo $user->no_regis; ?></h4>
                        <div class="ml-auto text-right">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a>Admin</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Daftar User</li>                                </ol>
                            </nav>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                  <div class="container-fluid">
                    <?php if ($this->session->flashdata('success_update')){ ?>
                        ...
                        <?php } ?>
                    <form method="POST" action="<?php site_url('Admin/edit_user/'.$user->no_regis); ?>">
                    <div class="form-group row">
                      <label class="col-md-3 col-form-label" for="text-input">No Registrasi</label>
                      <div class="col-md-9">
                        <input class="form-control" id="text-input" type="text" name="no_regis" value="<?php echo $user->no_regis; ?>">
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-md-3 col-form-label" for="text-input">Nama</label>
                      <div class="col-md-9">
                        <input class="form-control" id="text-input" type="text" name="nama" value="<?php echo $user->nama; ?>" >
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-md-3 col-form-label" for="text-input">Password</label>
                      <div class="col-md-9">
                        <input class="form-control" id="text-input" type="text" name="password" value="<?php echo $user->password; ?>"  >
                      </div>
                    </div>
                    <div class="form-group row">
                      <label class="col-md-3 col-form-label" for="text-input">Email</label>
                      <div class="col-md-9">
                        <input class="form-control" id="text-input" type="text" name="email" value="<?php echo $user->email; ?>" >
                      </div>
                    </div>
