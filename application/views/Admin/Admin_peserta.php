    ...
    <div id="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                          ...
                          if (!empty($mhs)) {
                           ...
                           ?>
                            <tr>
                              ...
                              <td>
                                <?php echo date('d-m-Y', strtotime($isi->start)); ?>
                              </td>
                              <td>
                                <?php echo date('d-m-Y', strtotime($isi->end)); ?>
                              </td>
                              <td>
                                <?php echo $isi->status; ?>
                              </td>
                              <td>
                                ...
                                <a onclick="deleteConfirm('<?php echo site_url('Admin/hapus_mhs/'.$isi->nim);?>')"
                                  href="#!" class="btn btn-small text-danger"><i class="fas fa-trash"></i> Hapus Data</a>
                              </td>
                              <?php if ($isi->status == 'Aktif') { ?>
                                <td class="bg-danger">
                                  <br/>
                                  <a href="<?php base_url(); ?>activated_mhs/<?php echo $isi->nim; ?>" class="btn btn-lg text-white"> Non-Aktifkan</a>
                                </td>
                              <?php } else { ?>
                                <td class="bg-success">
                                  <br/>
                                  <a href="<?php base_url(); ?>activated_mhs/<?php echo $isi->nim; ?>" class="btn btn-lg text-white"> Aktifkan</a>
                                </td>
                            <?php } ?>
                            </tr>
                          <?php endforeach;}
                ...
                <div class="card shadow mb-4" id="siswa">
                  <div class="card-header py-3">
                          ...
                          if (!empty($siswa)) {
                           ...
                           ?>
                            <tr>
                              ...
                              <td>
                                <a href="<?php base_url(); ?>lihat_Data_Siswa/<?php echo $isi->nisn; ?>" class="btn btn-small text-primary"><i class="fas fa-tv"></i> Lihat Data</a>
                                <a href="<?php base_url(); ?>edit_siswa/<?php echo $isi->nisn; ?>" class="btn btn-small text-primary"><i class="far fa-edit"></i> Edit Data</a>
                                <a onclick="deleteConfirm('<?php echo site_url('Admin/hapus_siswa/'.$isi->nisn);?>')"
                                  href="#!" class="btn btn-small text-danger"><i class="fas fa-trash"></i> Hapus Data</a>
                              </td>
                              <?php if ($isi->status == 'Aktif') { ?>
                                <td class="bg-danger">
                                  <br/>
                                  <a href="<?php base_url(); ?>activated_siswa/<?php echo $isi->nisn; ?>" class="btn btn-lg text-white"> Non-Aktifkan</a>
                                </td>
                              <?php } else { ?>
                                <td class="bg-success">
                                  <br/>
                                  <a href="<?php base_url(); ?>activated_siswa/<?php echo $isi->nisn; ?>" class="btn btn-lg text-white"> Aktifkan</a>
                                </td>
                            <?php } ?>
                            </tr>
                          <?php endforeach;}
